...
public class CreateBankAccount extends HttpServlet {
	...
	protected void service(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		if (flag==true) {
			...
			resp.getWriter().print("<h1 style='color: white;'>Congratulations your account has been created successfully .Please wait for Manager approval</h1>");
			req.getRequestDispatcher("Home.html").include(req, resp);
		}
		else {
			resp.getWriter().print("<h1 style='color: white;'>Already account is existed</h1>");
		}
	}
}
